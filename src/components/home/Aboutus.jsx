    ...
    >
      <div className="flex justify-between flex-wrap font-sangbleu">
        ...
        <p className="basis-[100%] lg:mt-0 mt-[0px] lg:basis-[25%]  lg:text-end">
          ...
          <button className="lg:block hidden border-primaryblue mt-[40px] font-[200] text-[12px] tracking-[1.5px] ml-auto border-solid border-[1px] text-primaryblue px-8 py-[14px]">
            EXPLORE MORE
          </button>
        </p>
      </div>
