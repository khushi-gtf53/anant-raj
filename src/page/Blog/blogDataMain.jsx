    ...
    return (
        <div className='max-w-[1600px] m-auto blogs_container lg:pb-[100px] pb-[60px] lg:px-[100px] px-[15px]' id='discover-blogs'>
            <div className='lg:pt-[80px] pt-[60px]'>
                <h3 className="text-primaryred font-sangbleu mb-[40px] uppercase text-left tracking-[2px] leading-[30px] lg:leading-[40px] text-[12.5px] lg:text-[20px] lg:max-w-[850px]">
                    Uncover Innovative Insights and Spark Your Imagination with Our Blog!
                </h3>

                {/* Latest Blogs */}
                <div className='latestBlogs pb-[50px]' id='latest'>
                    ...
                    <div ref={latestRef} className="overflow-hidden">
                        <div className='cards__wrapper flex flex-wrap justify-between'>
